  ...
  return (
    <div className='edit-profile'>
      <div className='form__container form__container_place_edit'>
        ...
        <form className='form'>
          <input className='form__input form__input_place_edit' required placeholder='E-mail' type='email' />
          <span className='form__error-span'></span>
          <input className='form__input form__input_place_edit' required placeholder='Имя' type='text' />
          <span className='form__error-span'></span>
        </form>
